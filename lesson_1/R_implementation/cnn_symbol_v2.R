...
get_symbol <- function(num_classes) {
  ...
  conv_1_1 = mx.symbol.Convolution(data = input_data, kernel = c(32,32), stride = c(1,1), num_filter = 32, name = "conv_1_1")
  conv_1_1 = mx.symbol.Activation(data = conv_1_1, act_type = "relu", name = "act_relu_1_1")
  conv_1_2 = mx.symbol.Convolution(data = conv_1_1, kernel = c(32,32), stride = c(1,1), num_filter = 30, name = "conv_1_2")
